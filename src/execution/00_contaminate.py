...
ADD_LABEL = True # TRUE = AÑADIR COLUMNA 'IS_ANOMALY' PARA INDICAR FILAS CONTAMINADAS
RANDOM_STATE = 42 # SEMILLA PARA ASEGURAR REPRODUCIBILIDAD DEL PROCESO ALEATORIO
SHOW_INFO = True # TRUE = MOSTRAR INFORMACIÓN DE PROCESO EN CONSOLA
